...
link:https://www.typescriptlang.org/tsconfig/#useUnknownInCatchVariables[useUnknownInCatchVariables]:: Makes error variables in catch blocks have type `unknown` instead of `any`, requiring you to verify what kind of error you caught before working with it.
+
