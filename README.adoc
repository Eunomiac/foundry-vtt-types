...
```
<3> This third parameter is `EmptyObject`. Don't ask, it just is.
<4> the fourth parameter is where you tell TypeScript what `system` looks like after `prepareDerivedData`.
